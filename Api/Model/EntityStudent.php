...
class EntityStudent
{
  ...
  {
    return (new Database(self::$tableStudent))->select("registration = '${registration}' AND active = '1'")->fetchObject(self::class);
  }
  ...
  /**
   * Método responsável por desativar um aluno no banco
   * @return boolean
   */
  public function deleteStudent()
  {
    ...
    $db->update("id_student = '${id_student}'", $data);
